...
while (ppp<=1)
    ...
    for t=1:(Nt-1)
        ...
        boundzC2scaled = boundzC2*L/Na;
        for i=1:K3_1
            if posz1(i,t+1) >= boundzC1scaled(1) && posz1(i,t+1) <= boundzC1scaled(end) && ~isempty(find(abs(posz1(i,t+1)-(L-posz2(1:K3_2,t+1)))<=epsilon2,1))
        ...
        for i=1:K3_2
            if posz2(i,t+1) >= boundzC2scaled(1) && posz2(i,t+1) <= boundzC2scaled(end) && ~isempty(find(abs(posz2(i,t+1)-(L-posz1(1:K3_1,t+1)))<=epsilon2,1))
