...
while (ppp<=100)
    ...
    for t=1:(Nt-1)
        ...
        kb2_1(boundC2_1)=0.9*ones(length(boundC2_1),1);
        kb2_2=zeros(length(a2),1);
        kb2_2(boundC2_2)=0.9*ones(length(boundC2_2),1);
        kc2_1=zeros(length(b2),1);
        kc2_1(boundC2_1)=0.9*ones(length(boundC2_1),1);
        kc2_2=zeros(length(b2),1);
        kc2_2(boundC2_2)=0.9*ones(length(boundC2_2),1);

        kb3_1=zeros(length(a3),1);
        kb3_1(boundC3_1)=0.9*ones(length(boundC3_1),1);
        kb3_2=zeros(length(a3),1);
        kb3_2(boundC3_2)=0.9*ones(length(boundC3_2),1);
        kc3_1=zeros(length(b3),1);
        kc3_1(boundC3_1)=0.9*ones(length(boundC3_1),1);
        kc3_2=zeros(length(b3),1);
        kc3_2(boundC3_2)=0.9*ones(length(boundC3_2),1);

        kb4=zeros(length(a4),1);
        kb4(boundC4)=0.9*ones(length(boundC4),1);
        kc4=zeros(length(b4),1);
        kc4(boundC4)=0.9*ones(length(boundC4),1);
        abmax=50;
